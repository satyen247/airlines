...
<head>
  ...
  <!-- icheck bootstrap -->
  <link rel="stylesheet" href="<?php echo base_url('assets/opms/plugins/icheck-bootstrap/icheck-bootstrap.min.css')?>">
  <!-- Theme style -->
...
<!-- AdminLTE App -->
<script src="<?php echo base_url('assets/opms/dist/js/adminlte.min.js')?>"></script>
</body>
</html>
