						...
						?>
							...
							<div role="button" relid="<?php echo $i; ?>"
								...
								<div class="job-main-data">
									...
									<a href="<?php echo base_url('jobs/view/'. $jobs['seo_title'].'/'.$jobs['_id'].'?keywords='.urlencode($search_keywords).'&pos_flt=0&location='.urlencode($search_location).'' ) ?>"><div class="job-details-logo " role="presentation">
									...
									<div class="job-details"
										...
										<div class="job-detail-row">
											<div class="job-title" aria-label="Job Title">											
												<a href="<?php echo base_url('jobs/view/'. $jobs['seo_title'].'/'.$jobs['_id'].'?keywords='.urlencode($search_keywords).'&pos_flt=0&location='.urlencode($search_location).'' ) ?>"
