                        ...
                        <div class="card">
                            <div class="stat-widget-two card-body">
                                <div class="stat-content">
                                    ...
                                    <div class="stat-digit"><?php echo $employers_count; ?></div>
                                </div>
                                <div class="progress">
                        ...
                        <div class="card">
                            <div class="stat-widget-two card-body">
                                <div class="stat-content">
                                    ...
                                    <div class="stat-digit"><?php echo $job_count; ?></div>
                                </div>
                                <div class="progress">
                                        ...
                                        <div class="item">
                                            <div class="testimonial-content">
                                                ...
                                                <div class="media">
                                                    ...
                                                    <img class="testimonial-author-img ml-3" src="<?php echo base_url('assets/admin/images/avatar/1.png')?>" alt="" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="item">
                                    ...
                                    <table class="table mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="round-img">
                                                        <a href=""><img width="35" src="<?php echo base_url('assets/admin/images/avatar/1.png')?>" alt=""></a>
                                                    </div>
                                                </td>
                                                <td>Lew Shawon</td>
