...
Class Mongo_db
{
	...
	{		
		...
		$auth_himadri = $config['mongo_db']['default']['settings']['auth'];
		$host_himadri = $config['mongo_db']['default']['connection']['host'];
		$port_himadri = $config['mongo_db']['default']['connection']['port'];
		$user_name_himadri = $config['mongo_db']['default']['connection']['user_name'];
		$user_password_himadri = $config['mongo_db']['default']['connection']['user_password'];
		$db_name_himadri = $config['mongo_db']['default']['connection']['db_name'];
		...
		try
		{
			...
			if($auth_himadri)
			{
				$this->connection = new MongoDB\Driver\Manager("mongodb://$host_himadri:$port_himadri", array("username" => $user_name_himadri, "password" => $user_password_himadri));
				$this->db = $this->connection;

			}else{

				$this->connection = new MongoDB\Driver\Manager("mongodb://$host_himadri:$port_himadri");
				$this->db = $this->connection;
